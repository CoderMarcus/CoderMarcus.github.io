    ...
    window.tram = function(t) {
        ...
        var q = e.frame = function() {
          ...
          , L = e.now = function() {
            ...
            return e && F.bind ? e.bind(t) : Date.now || function() {
                return +new Date
            }
        }()
          , C = l(function(e) {
            ...
            e.init = function(e) {
                ...
                F.backface && H.hideBackface && X(this.el, F.backface.css, "hidden")
            }
            ,
            b("add", r),
            b("start", o),
        ...
        F.transform && F.backface && (K.z = [x, "translateZ"],
        K.rotateZ = [_],
        K.scaleZ = [g],
        K.perspective = [y]);
        var J = /ms/
    ...
    i.define("scroll", t.exports = function(t) {
        ...
        function v(e) {
            ...
            if (!(i.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(a.className))) {
                var c, f = (c = a,
                d.test(c.hash) && c.host + c.pathname === n.host + n.pathname ? a.hash : "");
                if ("" !== f) {
                    var h = t(f);
...
, function(t, e, n) {
    ...
    r.define("forms", t.exports = function(t, e) {
        var n, o, a, s, u, c = {}, l = t(document), f = window.location, h = window.XDomainRequest && !window.atob, d = ".w-form", p = /e(-)?mail/i, v = /^\S+@\S+$/, m = window.alert, w = r.env(), g = /list-manage[1-9]?.com/i, b = e.debounce(function() {
            ...
            r.fileUploads.each(function(e) {
                !function(e, n) {
                    if (!n.fileUploads || !n.fileUploads[e])
                        return;
                    var i, r = t(n.fileUploads[e]), o = r.find("> .w-file-upload-default"), a = r.find("> .w-file-upload-uploading"), s = r.find("> .w-file-upload-success"), c = r.find("> .w-file-upload-error"), l = o.find(".w-file-upload-input"), f = o.find(".w-file-upload-label"), h = f.children(), d = c.find(".w-file-upload-error-msg"), p = s.find(".w-file-upload-file"), v = s.find(".w-file-remove-link"), m = p.find(".w-file-upload-file-name"), g = d.attr("data-w-size-error"), b = d.attr("data-w-type-error"), y = d.attr("data-w-generic-error");
                    if (w)
        ...
        return c.ready = c.design = c.preview = function() {
            !function() {
                ...
                h && s.indexOf("https://webflow.com") >= 0 && (s = s.replace("https://webflow.com", "http://formdata.webflow.com"));
            ...
            w || a || function() {
                ...
                l.on("change", d + ' form input[type="checkbox"]:not(.w-checkbox-input)', function(e) {
                    t(e.target).siblings(".w-checkbox-input").toggleClass("w--redirected-checked")
                }),
                l.on("change", d + ' form input[type="radio"]', function(e) {
                ...
                e.forEach(function(e) {
                    ...
                    i.default)(e, 2)
                      , r = n[0]
                      , o = n[1];
                    l.on("focus", d + ' form input[type="'.concat(r, '"]:not(') + o + ")", function(e) {
                        t(e.target).siblings(o).addClass("w--redirected-focus")
                    }),
                    l.on("blur", d + ' form input[type="'.concat(r, '"]:not(') + o + ")", function(e) {
